...
const dataSchema = new mongoose.Schema({
  ...
  fuerza:                { type: String, default: null },
  pullbackReal:          { type: Boolean, default: null },
...
async function fetchAndCalc(symbol) {
  ...
  return {
    ...
    fuerza:            resultado.detalles?.fuerza            || null,
    pullbackReal:      resultado.detalles?.pullbackReal      ?? null,
